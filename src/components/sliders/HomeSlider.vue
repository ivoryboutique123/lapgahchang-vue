          ...
          <div class="block-slideshow__body">
            <div class="owl-carousel">
              ...
              ><div
                  class="
                        ...
                        "
                  style="
                          background-image: url('/resources/images/slides/slide-1.jpg');
                        "
              ></div>
                <div
                    class="
                        ...
                        "
                    style="
                          background-image: url('/resources/images/slides/slide-1-mobile.jpg');
                        "
                ></div>
            ...
            ><div
                class="
                        ...
                        "
                style="
                          background-image: url('/resources/images/slides/slide-2.jpg');
                        "
            ></div>
              <div
                  class="
                        ...
                        "
                  style="
                          background-image: url('/resources/images/slides/slide-2-mobile.jpg');
                        "
              ></div>
              <div class="block-slideshow__slide-content">
                <div class="block-slideshow__slide-title">
            ...
            ><div
                class="
                        ...
                        "
                style="
                          background-image: url('/resources/images/slides/slide-3.jpg');
                        "
            ></div>
              <div
                  class="
                        ...
                        "
                  style="
                          background-image: url('/resources/images/slides/slide-3-mobile.jpg');
                        "
              ></div>
              <div class="block-slideshow__slide-content">
                <div class="block-slideshow__slide-title">
